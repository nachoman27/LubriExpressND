...
<body>
        ...
        <div class="container pb-5">
            <div class="row">
                <div class="col-lg-5 mt-5">
                    <div class="card mb-3">
                        <img class="card-img img-fluid" src="assets/img/shop_033.jpg" alt="Card image cap"
                            id="product-detail">
                    </div>
                    <div class="row">
                        <!--Start Controls-->
                            ...
                            <div class="carousel-inner product-links-wap" role="listbox">
                                ...
                                <div class="carousel-item active">
                                    <div class="row">
                                        <div class="col-4">
                                            <a href="#">
                                                <img class="card-img img-fluid" src="assets/img/shop_033.jpg"
                                                    alt="Product Image 1">
                                            </a>
                                        </div>
                                        <div class="col-4">
                ...
                <div class="col-lg-7 mt-5">
                    <div class="card">
                        <div class="card-body">
                            <h1 class="h2">LIQUI MOLY Motorbike 10W-50</h1>
                            <p class="h3 py-2">$28700.00</p>
                            <p class="py-2">
                                ...
                                <i class="fa fa-star text-warning"></i>
                                <i class="fa fa-star text-warning"></i>
                                <span class="list-inline-item text-dark">Reseñas 4.2 | 90 comentarios</span>
                            </p>
                            <ul class="list-inline">
                                ...
                                <li class="list-inline-item">
                                    <p class="text-muted"><strong>Liqui Moly</strong></p>
                                </li>
                            </ul>

                            <h6>Descripcion:</h6>
                            <p>Aceite de motor sintético de alto rendimiento. Máxima potencia y protección del motor en
                                todas las condiciones de servicio. Garantiza una lubricación óptima,
                                una excelente limpieza del motor, magníficos valores de fricción y un desgaste mínimo,
                                así como procesos suaves de embrague, desembrague y cambio de marchas.
                                Todo ello tiene como resultado un mayor placer de conducción. Sometido a prueba en
                                catalizadores. Sometido a prueba en circuitos. Desarrollado para motores de
                                4 tiempos con refrigeración de aire y agua sometidos a condiciones de servicio entre
                                normales y extremas. Para conducción deportiva. Apto para motores con y
                                sin embrague en baño de aceite.</p>
                            <h6>Especificaciones:</h6>
                            <ul class="list-unstyled pb-3">
                                <li>1 Litro</li>
                                <li>Clasificación SAE (aceites de motor): 10W-50</li>
                                <li>Densidad a 59 °F: 0,85 g/cm³ </li>
                                <li>Viscosidad a 104 °F: 124 mm²/s </li>
                                <li>Viscosidad a 212°F: 18,5 mm²/s</li>
                                <li>Índice de viscosidad: 165</li>
                                <li>Punto de fluidez: -38 °F</li>
                                <li>Punto de inflamación: 446 °F</li>
                                <li>Número total de bases: 7 mg KOH/g</li>

                            </ul>

                            <form action="producto_liqui_10W50.php" method="POST">
                                <input type="hidden" name="product_id" value="154">
                                <input type="hidden" name="product_name" value="LIQUI MOLY Motorbike 10W-50">
                                <input type="hidden" name="product_price" value="28700.00">
    ...
    <script src="assets/js/10w50.js"></script>
    <!-- End Script -->
