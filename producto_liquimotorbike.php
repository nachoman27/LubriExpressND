        ...
        <div class="container pb-5">
            <div class="row">
                <div class="col-lg-5 mt-5">
                    <div class="card mb-3">
                        <img class="card-img img-fluid" src="assets/img/shop_011.jpg" alt="Card image cap"
                            id="product-detail">
                    </div>
                    <div class="row">
                        <!--Start Controls-->
                            ...
                            <div class="carousel-inner product-links-wap" role="listbox">
                                ...
                                <div class="carousel-item active">
                                    <div class="row">
                                        <div class="col-4">
                                            <a href="#">
                                                <img class="card-img img-fluid" src="assets/img/product_single_1.jpg"
                                                    alt="Product Image 1">
                                            </a>
                                        </div>
                                        <div class="col-4">
                                            <a href="#">
                                                <img class="card-img img-fluid" src="assets/img/product_single_2.jpg"
                                                    alt="Product Image 2">
                                            </a>
                                        </div>
                                    </div>
                ...
                <div class="col-lg-7 mt-5">
                    <div class="card">
                        <div class="card-body">
                            <h1 class="h2">LIQUI MOLY Motorbike Cleaner</h1>
                            <p class="h3 py-2">$18400.00</p>
                            <p class="py-2">
                                ...
                                <i class="fa fa-star text-warning"></i>
                                <i class="fa fa-star text-warning"></i>
                                <span class="list-inline-item text-dark">Reseñas 4.7 | 76 comentarios</span>
                            </p>
                            ...
                            <h6>Descripción:</h6>
                            <p>
                                MOTORBIKE CLEANER es un limpiador especial para motocicletas de uso universal.
                                Disuelve restos de grasa, mugre y todo tipo de suciedad a fondo y en forma rápida,
                                por muy adherida que esté. De efecto rápido y anticorrosivo. Excelente resultado de
                                lavado y limpieza.
                                Escurre sin dejar rayas ni huellas.
                            </p>
                            <h6>Especificaciones:</h6>
                            <ul class="list-unstyled pb-3">
                                Características principales
                                <li>Línea: race </li>
                                <li>Viscocidad: 5W-30</li>
